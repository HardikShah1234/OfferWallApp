...
public class OfferWallViewModel extends ViewModel {
    ...
    public MutableLiveData<OfferResponse> getLiveData(int pageNumber, String appId, String userId, String token) {
        ...
        offerRequest = new OfferRequest(
                ...
                TIMESTAMP_VALUE,
                userId,
                getHashString(String.valueOf(pageNumber), appId, userId, token)
        );
        return (MutableLiveData<OfferResponse>) offerRepository.fetchOffers(
                compositeDisposable, offerRequest, token);
    }

    public void loadData(int pageNumber, String appId, String userId, String token) {
        offerRepository.fetchOffers(new OfferRequest(
                appId,
                IP_ADD,
                LOCALE_VALUE,
                OFFER_TYPES_VALUE,
    ...
    private String getHashString(String pageNumber, String appId, String userId, String token) {
        String apiRequestParams = APP_ID + "=".concat(appId)
